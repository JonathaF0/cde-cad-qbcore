--[[
    CDECAD Sync Configuration for QBCore
...
-- Map QBCore player data fields to CDECAD civilian fields
Config.FieldMapping = {
    -- QBCore charinfo -> CDECAD Civilian
...
-- Gender mapping (QBCore uses 0/1, CAD might use strings)
